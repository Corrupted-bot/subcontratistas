...
@section('content')
                                    ...
                                    @foreach ($contratos as $contrato)
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-info"
                                                    onclick="CargarEstadoPago({{ $contrato->id }},'{{ $contrato->nombre }}')">Estados
                    ...
                    <div class="card-body" id="bodyEstado">
                        <div style="display: flex;justify-content: center;" id="cartaInformacion">
                            <div class="alert alert-warning"
                                role="alert"style="width: -webkit-fill-available;text-align: center;">
    ...
    <div class="modal fade" id="modalCrearContrato" tabindex="-1" aria-labelledby="modalCrearContratoLabel"
        aria-hidden="true">
                    ...
                    <table id="archivosTabla" class="table table-striped table-bordered" style="width:100%;">
                        ...
                        <tbody style="text-align: center">
                            <tr>
                                ...
                                <td>
                                    <i class="fa-solid fa-circle-check fa-1x btn btn-success"></i>
                                    <i class="fa-solid fa-circle-xmark fa-1x btn btn-danger"></i>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
        ...
        function CargarEstadoPago(id, nombre) {
            ...
            $('#solicitudes').DataTable({
                ...
                buttons: [{
                    ...
                    text: '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalsolicitud">Agregar Solicitud <i class="fa-solid fa-plus"></i></button>',
                }, ],
                columnDefs: [{
                        width: 30,
                        targets: 0,
